...
public final class NDArray extends Table {
  public static NDArray getRootAsNDArray(ByteBuffer _bb) { return getRootAsNDArray(_bb, new NDArray()); }
  public static NDArray getRootAsNDArray(ByteBuffer _bb, NDArray obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public NDArray __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createNDArray(FlatBufferBuilder builder,
      int dataOffset,
      int shapeOffset) {
    builder.startObject(2);
    NDArray.addShape(builder, shapeOffset);
    NDArray.addData(builder, dataOffset);
    return NDArray.endNDArray(builder);
  }

  public static void startNDArray(FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endNDArray(FlatBufferBuilder builder) {
